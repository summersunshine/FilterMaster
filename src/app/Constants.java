...
public class Constants
{
	...
	public static final int		TYPE_CIRCLE_BLUR		= 304;
	public static final int		TYPE_VERTICAL_BLUR		= 305;
	public static final int		TYPE_HORIZONTAL_BLUR	= 306;
	...
	public static final int[]	TYPE_BLUR_LIST			= { TYPE_GUASS_BLUR, TYPE_LASER, TYPE_MOTION_BLUR };

	public static final int[]	TYPE_FUN_LIST			= { TYPE_ALPHA_MERGE, TYPE_ALPHA_MERGE_1, TYPE_ALPHA_MERGE_2, TYPE_ALPHA_MERGE_3, TYPE_ALPHA_MERGE_4,
			TYPE_CONCAVE_MIRROIR, TYPE_CONVEX_MIRROIR, TYPE_MOSIC };

	public static final int[]	TYPE_LOMO_LIST			= { TYPE_LOMO_CLASSIC, TYPE_LOMO_MEMORY };

	public static final int[]	TYPE_STYLE_LIST			= { TYPE_RETRO_STYLE, TYPE_DUSK_STYLE, TYPE_YOUTH_STYLE };

	public static final int[]	TYPE_FASHION_LIST		= { TYPE_RAINBOW, TYPE_PHOTON, TYPE_PARCHMENT, TYPE_FLARE };

	public static final int[]	TYPE_FRAME_LIST			= { TYPE_FRAME_WOOD, TYPE_FRAME_INSTANT, TYPE_FRAME_FILM, TYPE_FRAME_SIMPLE };

	public static String[]		DESCRIBE_ART_LIST		= { "ÓÍ»­", "Ç¦±Ê", "¸¡µñ", "ËØÃè" };

...
public class FunImageFactory
{
	...
	public static BufferedImage getImage(int type, BufferedImage image, Object... parameter)
	{
		...
		case (Constants.TYPE_ALPHA_MERGE_1):
			return AlphaMerge.getImage(image, (BufferedImage) (parameter[0]), AlphaMerge.Constants.TYPE_DOWN_2_UP);
		case (Constants.TYPE_ALPHA_MERGE_2):
			return AlphaMerge.getImage(image, (BufferedImage) (parameter[0]), AlphaMerge.Constants.TYPE_UP_2_DOWN);
		case (Constants.TYPE_ALPHA_MERGE_3):
			return AlphaMerge.getImage(image, (BufferedImage) (parameter[0]), AlphaMerge.Constants.TYPE_LEFT_2_RIGHT);
		case (Constants.TYPE_ALPHA_MERGE_4):
			return AlphaMerge.getImage(image, (BufferedImage) (parameter[0]), AlphaMerge.Constants.TYPE_RIGHT_2_LEFT);
		case (Constants.TYPE_MAGIC_MIRROIR_1):
			return MagicMirror.getImage(image, MagicMirror.Constants.TYPE_CONCAVE);
		case (Constants.TYPE_MAGIC_MIRROIR_2):
			return MagicMirror.getImage(image, MagicMirror.Constants.TYPE_CONVEX);

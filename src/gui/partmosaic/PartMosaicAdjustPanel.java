...
public class PartMosaicAdjustPanel extends JPanel implements AdjustmentListener
{
	// 画笔大小滚动条
	...
	public void adjustmentValueChanged(AdjustmentEvent e)
	{
		...
		if (e.getSource() == sizeScrollBar)
		{
			...
			PartMosaicFrame.sizeValue = e.getValue();

		}
		if (e.getSource() == levelScrollBar)
		{
			PartMosaicFrame.levelValue = e.getValue();
		}
	}
